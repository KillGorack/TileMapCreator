...
{
    // ── recipes (unchanged from WPF) ────────────────────────────────────────
    public static readonly int[][] TileSetRecipe = new int[][]
    {
        new[] { 1,2,3,6,7,8,9 }, new[] { 1,2,3,4,7 },   new[] { 1,2,3,4,7,9 },
        new[] { 1,2,3,7,9 },     new[] { 1,3,4,7 },      new[] { 1,4,7 },
        new[] { 7,9 },           new[] { 9 },             new[] { 1,2,3,7,8,9 },
        new[] { 1,3,7 },         Array.Empty<int>(),      new[] { 1,3,4,6,7,8,9 },
        new[] { 1,2,3,6,9 },     new[] { 1,2,3,6,7,9 },  new[] { 1,3,7,8,9 },
        new[] { 1,3,6,9 },       new[] { 3,6,9 },         new[] { 1,3 },
        new[] { 7 },             new[] { 1,3,4,6,7,9 },  new[] { 3,7,9 },
        new[] { 1,2,3,4,6,7,8,9 }, new[] { 1,2,3,4,6,7,9 }, new[] { 1,4,7,8,9 },
        new[] { 1,3,4,7,8,9 },   new[] { 1,3,4,7,9 },    new[] { 1,2,3,7 },
        new[] { 1,2,3 },         new[] { 3,9 },           new[] { 3 },
        new[] { 3,7 },           new[] { 1,3,9 },         new[] { 1,2,3,4,5,6,7,8,9 },
        new[] { 1,2,3,4,7,8,9 }, new[] { 3,6,7,8,9 },    new[] { 1,3,6,7,8,9 },
        new[] { 1,3,6,7,9 },     new[] { 1,2,3,9 },       new[] { 7,8,9 },
        new[] { 1,7 },           new[] { 1 },             new[] { 1,9 },
        new[] { 1,3,7 },         new[] { 1,3,7,9 },
    };

    public static readonly int[][] TileSetRecipeB = new int[][]
    {
        new[] { 2,3,4 }, new[] { 1,3,4 }, new[] { 1,2,4 }, new[] { 1,2,3 },
        new[] { 1,2 },   new[] { 3,4 },   new[] { 1,3 },   new[] { 2,4 },
        new[] { 1 },     new[] { 2 },     new[] { 3 },     new[] { 4 },
        new[] { 2,3 },   new[] { 1,4 },   Array.Empty<int>(), new[] { 1,2,3,4 },
    };
